...
public class Telefone implements Serializable {
	...
	@Column(name = "descricao_telefone",nullable = false)
	private String descricaoTelefone;
	
	@NotNull(message = "Tem que selecionar algum tipo de telefone")
	...
	public Telefone(Integer id, String descricaoTelefone) {
		this.id = id;
